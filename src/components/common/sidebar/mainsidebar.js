    ...
    <div className="sidebar">
      ...
      <div className="sidebar-menu">
        ...
        <div className={`submenu sidebar-submenu ${showEmployeeMenu ? "open" : ""}`}>
          <Link to="/employees" className={`sidebar-subitem ${isActive("/employees") ? "active" : ""}`}>
            Employee Directory
          </Link>
          <Link to="/onboarding" className={`sidebar-subitem ${isActive("/onboarding") ? "active" : ""}`}>
            Onboarding Form
          </Link>
          <Link to="/attendance" className={`sidebar-subitem ${isActive("/attendance") ? "active" : ""}`}>
            Attendance
          </Link>
          <Link to="/leave" className={`sidebar-subitem ${isActive("/leave") ? "active" : ""}`}>
            Leave Management
          </Link>
          <Link to="/exit" className={`sidebar-subitem ${isActive("/exit") ? "active" : ""}`}>
            Exit Formality
          </Link>
        </div>
        ...
        <div className={`submenu sidebar-submenu ${showAssetMenu ? "open" : ""}`}>
          <Link to="/assets/master" className={`sidebar-subitem ${isActive("/assets/master") ? "active" : ""}`}>
            Asset Master
          </Link>
          <Link to="/assets/assign" className={`sidebar-subitem ${isActive("/assets/assign") ? "active" : ""}`}>
            Assign Asset
          </Link>
          <Link to="/assets/return" className={`sidebar-subitem ${isActive("/assets/return") ? "active" : ""}`}>
            Return Asset
          </Link>
          <Link to="/assets/maintenance" className={`sidebar-subitem ${isActive("/assets/maintenance") ? "active" : ""}`}>
            Maintenance Schedule
          </Link>
          <Link to="/assets/disposal" className={`sidebar-subitem ${isActive("/assets/disposal") ? "active" : ""}`}>
            Asset Disposal
          </Link>
        </div>
        ...
        <Link
          to="/ess-portal"
          className={`sidebar-item ${isActive("/ess-portal") ? "active" : ""}`}
        >
